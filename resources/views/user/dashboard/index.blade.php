    ...
    <section class="pb-5" id="why_us" style="background-color: var(--hijau)">
        <div class="container py-5">
            ...
            <div class="row d-flex justify-content-center mt-4">
                <div class="col-12 col-md-6 col-lg-3 d-flex justify-content-center" data-aos="fade-right" data-aos-duration="450" data-aos-anchor="#why_us" data-aos-offset="250">
                ...
                <div class="col-12 col-md-6 col-lg-3 d-flex justify-content-center" data-aos="fade-left" data-aos-duration="450" data-aos-anchor="#why_us" data-aos-offset="250">
                    <div class="card rounded-0 border border-2 border-dark p-3 py-5 text-center mt-3 shadow-border card-keunggulan">
        ...
        <div class="container-xxl p-5">
            ...
            <div class="row d-flex justify-content-center mt-4">
                <div class="col-12 col-md-4 mt-2" data-aos="fade-down" data-aos-duration="450" data-aos-anchor="#menu" data-aos-offset="250">
                    <img src="https://www.homade.id/wp-content/uploads/2020/05/menu-ayam-geprek.jpg" class="img-fluid shadow-border" alt="">
            ...
            <a href="{{ route('user.menu') }}" class="btn rounded-0 px-3 py-2 shadow-border btn-hover text-light border border-2 border-dark mt-3" style="background-color: var(--merah)" data-aos="fade-right" data-aos-anchor="#menu" data-aos-offset="750" data-aos-duration="450">Lihat menu lainnya...</a>
        </div>
    </section>
